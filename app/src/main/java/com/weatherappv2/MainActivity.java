        ...
        Dexter.withActivity(this)
                ...
                .withListener(new MultiplePermissionsListener() {
                    ...
                    public void onPermissionRationaleShouldBeShown(List<PermissionRequest> permissions, PermissionToken token) {
                        Snackbar.make(coordinatorLayout,"Permission Denided",Snackbar.LENGTH_LONG)
                                .show();
                    }
                }).check();
    ...
    private void builLocationCallBack() {
        ...
        locationCallback = new LocationCallback(){
            ...
            public void onLocationResult(LocationResult locationResult) {
                ...
                Log.d("ololo",locationResult.getLastLocation().getLatitude()+"/"+locationResult.getLastLocation().getLongitude());
            }
        };
    }
